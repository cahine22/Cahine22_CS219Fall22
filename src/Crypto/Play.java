...
public class Play {
    ...
    public static void main(String [] args)
    {
        ...
        System.out.println(3/2); // only 1 would get printed out because its integer division, not dealing with doubles (decimals)
        System.out.println(-3/2); // -1
        System.out.println(Math.floor(-1.25)); // -2.0
        System.out.println(Math.floor(-33.1)); // -34.0
        System.out.println(Math.floor(1.25)); // 1.0
        System.out.println(Math.floor(-5/2)); // -2.0
        System.out.println(Math.floor(-5/2.0)); // -3.0
        System.out.println(Math.floorDiv(-3,2)); // -2 (gives int back because int divided by int)
